      ...
      <div className="flex flex-wrap gap-8 justify-around">
        <div className="">
          <Image
            ...
            width={450}
            height={450}
            className="lg:w-[450px] md:w-[350px] sm:w-[512px]" />
        </div>
        <div className="max-w-3xl lg:text-start sm:text-center">
          <h1 className="font-bold text-3xl mb-2">I'm <span className="text-[#0064ec]">Adarsh Adamane</span></h1>
          <p className="text-gray-600 font-bold text-2xl pb-2">I’m a <span className="text-[#0064ec]">creative</span> developer who loves turning ideas into interactive, <span className="text-[#0064ec]">user-friendly designs</span>.</p>
